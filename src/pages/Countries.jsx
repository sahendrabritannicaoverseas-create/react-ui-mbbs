...
const Countries = () => {
    ...
    return (
        <div className="main-page-wrapper bg-white">
            <section className="relative pt-[160px] pb-[80px] bg-slate-100 overflow-hidden">
                <div className="container mx-auto px-6 relative z-10">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                        ...
                        >
                            <ul className="flex items-center gap-3 text-slate-400 font-black text-[10px] uppercase tracking-[0.2em] mb-6">
                                ...
                                <li><Link to="/countries" className="hover:text-brand-primary transition-colors">Countries</Link></li>
                                <li><BiChevronRight className="text-slate-300" /></li>
                                <li className="text-brand-primary">{id}</li>
                            </ul>
                            <h1 className="text-4xl md:text-6xl font-black text-slate-900 uppercase tracking-tighter">MBBS in <span className="gradient-text">{id}</span></h1>
                        </motion.div>
                        <motion.div
                        ...
                        >
                            ...
                            <div className="pr-6">
                                ...
                                <p className="text-sm font-black text-slate-900 uppercase tracking-tight">Open for 2025</p>
                            </div>
                        </motion.div>
                    </div>
                </div>
                        ...
                        >
                            <aside className="sticky top-32 space-y-10">
                                ...
                                <div className="bg-slate-900 rounded-[40px] p-10 text-white relative overflow-hidden shadow-2xl">
                                    ...
                                    <h4 className="text-3xl font-black mb-4 uppercase tracking-tighter leading-tight">Start Your <span className="text-brand-secondary">Journey</span></h4>
                                    <p className="text-slate-400 mb-10 font-medium text-sm">Need help in choosing the right university? Our experts are here to assist you.</p>
                                    <Link
                                        to="#"
