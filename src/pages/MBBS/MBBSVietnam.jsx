...
const MBBSVietnam = () => {
    ...
    return (
        <main className="overflow-hidden bg-slate-50 min-h-screen">
            <Meta
                title="Study MBBS in Vietnam 2024 - Top Medical Universities"
                description="Apply for MBBS in Vietnam 2024. Low tuition fees, English medium programs, and globally recognized medical degrees at Top Vietnam Universities."
            />
            {/* Page Title Area */}
                ...
                <div className="container mx-auto px-6 lg:px-12 max-w-7xl relative z-10 text-center xl:text-left">
                    ...
                    >
                        <h1 className="text-3xl md:text-4xl font-black text-white mb-4 uppercase tracking-tight">
                            MBBS <span className="text-brand-secondary">Vietnam</span>
                        </h1>
