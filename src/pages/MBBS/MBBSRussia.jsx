...
import { BiRightArrowAlt, BiMapPin, BiCheckCircle, BiInfoCircle, BiDetail, BiBuildings, BiMoney, BiUserCheck, BiFile, BiBookOpen, BiGlobe } from 'react-icons/bi';
                ...
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto space-y-20">
                        ...
                        <motion.section id="intro-section" {...fadeInUp} className="scroll-mt-32">
                            ...
                            <div className="mt-12 bg-[#f3f8ff] rounded-[24px] p-8 border border-[#e1ecf8] shadow-sm">
