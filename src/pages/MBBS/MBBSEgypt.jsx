...
const MBBSEgypt = () => {
    ...
    const universities = [
        {
            ...
            img: uniMasha,
            desc: 'One of the oldest and most prestigious universities in Egypt.',
    ...
    return (
        <main className="overflow-hidden bg-slate-50 min-h-screen">
            <Meta
                title="Study MBBS in Egypt 2026 - Top Medical Universities"
                description="Apply for MBBS in Egypt 2026. Quality education, low cost, english medium, and NMC/WHO recognized medical degrees."
            />
            {/* Page Title Area */}
                ...
                <div className="container mx-auto px-6 lg:px-12 max-w-7xl relative z-10 text-center xl:text-left">
                    ...
                    >
                        <h1 className="text-3xl md:text-4xl font-black text-white mb-4 uppercase tracking-tight">
                            MBBS In <span className="text-brand-secondary">Egypt</span>
                        </h1>
                        <ul className="flex items-center justify-center xl:justify-start gap-4 text-slate-400 font-bold text-[10px] uppercase tracking-widest">
                            ...
                            <li className="text-brand-secondary">Egypt Universities</li>
                        </ul>
                    </motion.div>
                </div>
            </section>
                                    ...
                                    currentUnis.map((uni, idx) => (
                                        ...
                                        >
                                            <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8">
                                                ...
                                                <Link to={`/mbbs/egypt/${uni.slug}`} className="w-32 h-32 md:w-36 md:h-36 rounded-xl border border-slate-100 p-3 bg-white flex-shrink-0 flex items-center justify-center overflow-hidden shadow-sm hover:border-brand-primary/30 transition-all">
                                                    <img
                                                        src={uni.img}
                                                        alt={uni.name}
