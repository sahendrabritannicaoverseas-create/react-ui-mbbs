        ...
        <main className="overflow-hidden bg-white">
            ...
            <section className="relative pt-[160px] pb-[120px] bg-slate-900 overflow-hidden">
                ...
                <div className="container mx-auto px-6 relative z-10 text-center xl:text-left">
                    ...
                    >
                        <h2 className="text-2xl md:text-4xl font-black text-white mb-6 uppercase tracking-tight">
                ...
                <div className="container mx-auto px-6">
                    ...
                    <div className="space-y-24">
                        {categories.map((cat, idx) => (
                            <div key={idx} id={cat.country.toLowerCase().replace(/\s+/g, '-')} className="last:mb-0">
                                <motion.div
                                    {...fadeInUp}
